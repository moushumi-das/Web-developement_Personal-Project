...
function updateCart(item) {
  axios__WEBPACK_IMPORTED_MODULE_2___default().post('/update-cart', item).then(function (res) {
...
function reduceCartItem(item) {
  axios__WEBPACK_IMPORTED_MODULE_2___default().post('/reduce-cart', item).then(function (res) {
    //console.log(res.data.totalQty)
    cartCouter.innerText = res.data.totalQty;
...
function updateStatus(order) {
  ...
  orderStatus.forEach(function (status) {
    //
    var datas = status.dataset.status; //console.log(datas)
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var stripe, elements, style, card, paymentMethod, srtipePayment;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_3__.loadStripe)('pk_test_51J6LHZKXBspD5h0ztZ4VCDD7TP310reDozCqDVaN5KFgujqOlV5FQO3ZYDS8vtgKaL9bJmAkxtq7yse4eqBBsEOk00yjsEAJCu');
          ...
          case 2:
            ...
            paymentMethod.addEventListener('change', function (event) {
              ...
              if (event.target.value === 'card') {} else {}
            }); //Ajax

            srtipePayment = document.querySelector('#srtipe_payment_form');

            if (srtipePayment) {
              srtipePayment.addEventListener('submit', function (e) {
                e.preventDefault();
                console.log(e); //The FormData interface provides a way to easily construct a set of key/value pairs representing form fields and their values,

                var paymentFormData = new FormData(srtipePayment);
                var paymentFormObject = {};

                var _iterator = _createForOfIteratorHelper(paymentFormData.entries()),
                    _step;
                ...
                axios__WEBPACK_IMPORTED_MODULE_2___default().post('/order', paymentFormObject).then(function (res) {
